...
//     public UserDashboard(User user, AuthController authController, AccountService accountService, TransactionRepository transactionRepository, AccountRepository accountRepository) {
...
//         // authService.updateUser(currentUser); // Méthode supprimée
...
//             // currentUser = authService.getLoggedInUserByEmail(currentUser.getEmail()); // Méthode supprimée
